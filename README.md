...
An animated wallpaper inspired by the solar system of *Outer Wilds*, built with HTML, CSS, and JavaScript for Wallpaper Engine. It features orbiting celestial bodies, the Interloper, the Quantum Moon, and a clock showing the current time.
